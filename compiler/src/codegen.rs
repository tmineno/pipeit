...
impl<'a> CodegenCtx<'a> {
    ...
    fn emit_main(&mut self) {
        ...
        self.out.push_str("    bool _stats = false;\n");
        self.out
        ...
        self.out
            .push_str("    (void)_probe_output; (void)_enabled_probes;\n");
        self.out.push('\n');

        self.out.push_str("    if (_stats) {\n");
        let _ = writeln!(
            self.out,
            "        std::fprintf(stderr, \"[stats] tasks={} (detailed counters not enabled in v0.1.0)\\\\n\");",
            task_names.len()
        );
        self.out.push_str("    }\n");
        self.out.push('\n');
        ...
        self.out
            .push_str("    if (_stop.load(std::memory_order_acquire)) {\n");
