...
1. **Language spec rule (Pipit)**  
   ...
   (Added at `pipit-lang-spec-v0.2.0.md` §5.4.4)
...
2. **Compiler spec rule (pcc)**  
   ...
   (Added at `pcc-spec-v0.2.0.md` §9.1)
...
4. **Spec structure update**  
   Publish compiler spec as `pcc-spec-v0.2.0.md` and apply explicit section numbering for stable cross-references.
...
- Improves maintainability of documentation via stable numbered references in `pcc-spec-v0.2.0.md`.
