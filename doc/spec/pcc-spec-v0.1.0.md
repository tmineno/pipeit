...
Refer to [pipit-lang-spec-v0.1.0](pipit-lang-spec-v0.1.0.md) for the full language semantics. This spec defines `pcc`'s behavior as a tool.
...
- IDE integration (LSP) is out of scope for v0.1.0
...
| `schedule` | Schedule generation — topological order, K determination, batching |
...
### `--emit cpp`: Generated C++ source only
...
| 6. Schedule Generation | Topological order, K determination, batching | |
